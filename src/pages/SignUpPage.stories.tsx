...
/**
 * Mock version of SignUpPage for Storybook.
 * The real page uses Clerk's <SignUp /> component which requires ClerkProvider.
  ...
  decorators: [
    (Story) => (
      <MemoryRouter initialEntries={['/sign-up']}>
        <Routes>
          <Route path="/sign-up" element={<Story />} />
...
} satisfies Meta<typeof MockSignUpPage>;

export default meta;
type Story = StoryObj<typeof meta>;

/**
 * Default sign-up page with feature panel on the left and registration form on the right.
 */
